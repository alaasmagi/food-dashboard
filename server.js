...
const DB_PATH = process.env.DB_PATH || path.join(__dirname, "data", "cache.json");
const RESTAURANTS_PATH = process.env.RESTAURANTS_PATH || path.join(__dirname, "data", "restaurants.json");
...
async function readRestaurantConfig() {
